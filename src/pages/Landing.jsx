...
const FAQ = [
  ...
  { q: "What about forex?", a: "Crypto is live today; forex, gold and the indices are coming. Everything in the replay engine already works for them — what's outstanding is a data licence, since a free tool still needs the right to show a provider's price history to its users. We'd rather wait for that than ship a feed we shouldn't be using." },
    ...
    <div style={{ display: "grid", gap: 10 }}>
      ...
      <div style={{ display: "grid", gap: 5 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 10px",
          ...
          <span style={{ fontWeight: 600 }}>ETH/USDT</span><span className="sm mut">Binance</span>
        </div>
      </div>
